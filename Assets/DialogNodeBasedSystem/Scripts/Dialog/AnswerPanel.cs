...
namespace cherrydev
{
    public class AnswerPanel : MonoBehaviour
    {
        ...
        public virtual void SetUpButtons(int maxAmountOfAnswerButtons)
        {
            DeleteAllExistingButtons();
            
            for (int i = 0; i < maxAmountOfAnswerButtons; i++)
            {
                Button answerButton = _diContainer.InstantiatePrefabForComponent<Button>(_answerButtonPrefab,_parentTransform); //Instantiate(_answerButtonPrefab, _parentTransform);
